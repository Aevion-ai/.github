...
| **Open-Obligation Surface** | Machine-readable Godel register of every unproven obligation | Named, categorized, receipt-stamped - no confidence percentages |
...
| Signal | Result | Date |
|--------|--------|------|
| Kaggle AIMO Progress Prize 3 | Best recorded submission score **42.0**; final rank **601 / 4,138** (historical peak rank 141) | 2026 |
